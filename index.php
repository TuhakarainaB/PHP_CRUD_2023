  ...
  <body class="container">
      ...
      <div>
          <ul class="nav navbar-dark bg-dark">
              ...
              <li class="nav-item active">
                  <a href="create.php" class="nav-link text-light">Create a new Kenworth record.</a>
            </li>
          </ul>
      </div>
    <h1>Kenworth CRUD Application</h1>
    <div>
        <?php
            ...
            if(isset($_GET['link']))
            {
                ...
                // prepared statement
                $stmt = $connection->prepare("select * from kenworth where model = ?");
                if(!$stmt)
                {
            ...
            else
            {
                echo "
                    ...
                    <p><img src='images/kw_logo.png' alt='Kenworth CRUD Application' class='img-fluid'></p>
                ";
            }
