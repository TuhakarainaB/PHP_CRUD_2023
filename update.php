  ...
  <body class="container">
     ...
     <?php
           ...
           if(isset($_POST['update']))
           {
                ...
                $update = $connection->prepare("update kenworth set model=?, tagline=?, content=?, image=?  where id=?");
    ...
    <form method="post" action="update.php" class="form-group">
        ...
        <br>
        <input type="text" name="model" placeholder="Model..." class="form-control" value="<?php echo isset($row['model']) ? $row['model'] : ''; ?>">
        <br><br>
