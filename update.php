  ...
  <body class="container">
      <?php
            ...
            if(isset($_POST['update']))
            {
                ...
                $update = $connection->prepare("update kenworth set model=?, image=?, tagline=?, description=? where id=?");
    ...
    <div class="p-3 bg-light border shadow">
        <form method="post" action="update.php" class="form-group">
            ...
            <label>Model:</label>
            <br>
            <input type="text" name="model" placeholder="Model..." class="form-control" required value="<?php echo $row['model']; ?>">
            <br><br>
            <label>Image:</label>
            <br>
